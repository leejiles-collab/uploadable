...
public enum SpecCatalog {
    ...
    /// photo will be rejected on grounds Uploadable deliberately does not check.
    ///
    ...
    public static let usVisa = UploadSpec(
        ...
        caveats: [
            "The page also asks for a compression ratio of 20:1 or lower. Uploadable "
    ...
    public static let indiaEVisa = UploadSpec(
        ...
        caveats: [
            ...
            + "must be square. Uploadable keeps as much resolution as the byte band allows."
        ]
    )
    ...
    public static let usPassport = UploadSpec(
        ...
        caveats: [
            ...
            "JPG, JPEG, PNG, HEIC and HEIF are all accepted. Uploadable writes JPEG, "
