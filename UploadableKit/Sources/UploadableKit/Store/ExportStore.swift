...
/// The meter.
///
/// Fitting a photo is free and unlimited — anyone can run any photo against
/// any spec and see the whole Done screen. The result *is* the sales pitch, and
...
public actor ExportStore {
    ...
    private static let usedKey = "com.uploadable.exportsUsed"
    private static let hashesKey = "com.uploadable.exportedHashes"
