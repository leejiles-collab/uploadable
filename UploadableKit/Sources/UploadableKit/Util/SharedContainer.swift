...
/// The Uploadable folder — where a saved photo goes and how it gets there.
///
...
public enum FilesLibrary {
    ...
    public static let userFacingLocation = "Files → Uploadable"
    ...
    /// The app's Documents directory, shown in Files as *On My iPhone → Uploadable*.
